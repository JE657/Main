...
PROGRAM DESCRIPTION:Return an .xlsl worksheet containing Pricing Details and Contact Information
    ...
    def __init__(self):
        ...
        Variables: 
            base_url:   (str): contains the base url for which all scraping will take place from 
                        ...
                        where '?cat' in the url takes a 3 digit number corresponding to a 'cat'getory on the site
